...
このデータが名前として表示される。',
	PASSWORD VARCHAR(60) NOT NULL COMMENT 'パスワード : パスワード',
	MAIL_ADDRESS VARCHAR(255) UNIQUE COMMENT 'メールアドレス : メールアドレス',
	BIRTH_DATE DATE COMMENT '誕生日 : 誕生日
時間までは考慮しない
特に入力する必要もないのでNULLを許容する',
	PROFILE_SENTENCE VARCHAR(200) COMMENT 'プロフィール文 : プロフィール文
長いのも困るので300文字',
	REGISTER_DATETIME DATETIME NOT NULL COMMENT '登録日時 : 登録日時
