package demo.dbflute.allcommon;
...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("FAVOLITE", "demo.dbflute.bsentity.dbmeta.FavoliteDbm");
        tmpMap.put("FOLLOW", "demo.dbflute.bsentity.dbmeta.FollowDbm");
        tmpMap.put("REPLY", "demo.dbflute.bsentity.dbmeta.ReplyDbm");
        tmpMap.put("RETWEET", "demo.dbflute.bsentity.dbmeta.RetweetDbm");
        tmpMap.put("TWEET", "demo.dbflute.bsentity.dbmeta.TweetDbm");
        tmpMap.put("USER", "demo.dbflute.bsentity.dbmeta.UserDbm");
