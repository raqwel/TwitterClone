...
public abstract class BsUser extends AbstractEntity implements DomainEntity {
    ...
    /**
     * [get] MAIL_ADDRESS: {UQ, NotNull, VARCHAR(255)} <br>
     * メールアドレス : メールアドレス
    ...
    /**
     * [set] MAIL_ADDRESS: {UQ, NotNull, VARCHAR(255)} <br>
     * メールアドレス : メールアドレス
    ...
    /**
     * [get] PROFILE_SENTENCE: {NotNull, VARCHAR(200)} <br>
     * プロフィール文 : プロフィール文<br>
     * 長いのも困るので300文字
     * @return The value of the column 'PROFILE_SENTENCE'. (basically NotNull if selected: for the constraint)
     */
    ...
    /**
     * [set] PROFILE_SENTENCE: {NotNull, VARCHAR(200)} <br>
     * プロフィール文 : プロフィール文<br>
     * 長いのも困るので300文字
     * @param profileSentence The value of the column 'PROFILE_SENTENCE'. (basically NotNull if update: for the constraint)
     */
