...
public class FavoliteDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "demo.dbflute.exentity.Favolite"; }
    public String getConditionBeanTypeName() { return "demo.dbflute.cbean.FavoliteCB"; }
    public String getBehaviorTypeName() { return "demo.dbflute.exbhv.FavoliteBhv"; }
