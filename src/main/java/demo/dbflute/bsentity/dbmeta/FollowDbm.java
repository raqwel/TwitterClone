...
public class FollowDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "demo.dbflute.exentity.Follow"; }
    public String getConditionBeanTypeName() { return "demo.dbflute.cbean.FollowCB"; }
    public String getBehaviorTypeName() { return "demo.dbflute.exbhv.FollowBhv"; }
