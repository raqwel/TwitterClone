...
public class TweetDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.twitter.dbflute.exentity.Tweet"; }
    public String getConditionBeanTypeName() { return "com.example.twitter.dbflute.cbean.TweetCB"; }
    public String getBehaviorTypeName() { return "com.example.twitter.dbflute.exbhv.TweetBhv"; }
