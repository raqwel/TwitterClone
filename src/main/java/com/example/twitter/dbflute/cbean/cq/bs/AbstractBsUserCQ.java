...
public abstract class AbstractBsUserCQ extends AbstractConditionQuery {
    ...
    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * MAIL_ADDRESS: {UQ, VARCHAR(255)} <br>
    ...
    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * PROFILE_SENTENCE: {VARCHAR(200)} <br>
     ...
     * PROFILE_SENTENCE: {VARCHAR(200)}
     */
    public void setProfileSentence_IsNull() { regProfileSentence(CK_ISN, DOBJ); }

    /**
     * IsNullOrEmpty {is null or empty}. And OnlyOnceRegistered. <br>
     * PROFILE_SENTENCE: {VARCHAR(200)}
     */
    public void setProfileSentence_IsNullOrEmpty() { regProfileSentence(CK_ISNOE, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * PROFILE_SENTENCE: {VARCHAR(200)}
     */
    public void setProfileSentence_IsNotNull() { regProfileSentence(CK_ISNN, DOBJ); }
