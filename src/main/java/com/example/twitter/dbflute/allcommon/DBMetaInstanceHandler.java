...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("FAVOLITE", "com.example.twitter.dbflute.bsentity.dbmeta.FavoliteDbm");
        tmpMap.put("FOLLOW", "com.example.twitter.dbflute.bsentity.dbmeta.FollowDbm");
        tmpMap.put("REPLY", "com.example.twitter.dbflute.bsentity.dbmeta.ReplyDbm");
        tmpMap.put("RETWEET", "com.example.twitter.dbflute.bsentity.dbmeta.RetweetDbm");
        tmpMap.put("TWEET", "com.example.twitter.dbflute.bsentity.dbmeta.TweetDbm");
        tmpMap.put("USER", "com.example.twitter.dbflute.bsentity.dbmeta.UserDbm");
