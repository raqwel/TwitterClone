...
public abstract class BsUserBhv extends AbstractBehaviorWritable<User, UserCB> {
     ...
     * <pre>
     * <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">loadFavolite</span>(<span style="color: #553000">userList</span>, <span style="color: #553000">favoliteCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public NestedReferrerListGateway<Favolite> loadFavolite(List<User> userList, ReferrerConditionSetupper<FavoliteCB> refCBLambda) {
        xassLRArg(userList, refCBLambda);
        return doLoadFavolite(userList, new LoadReferrerOption<FavoliteCB, Favolite>().xinit(refCBLambda));
    }
     ...
     * FAVOLITE by USER_ID, named 'favoliteList'.
     * <pre>
     * <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">loadFavolite</span>(<span style="color: #553000">user</span>, <span style="color: #553000">favoliteCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">favoliteCB</span>.setupSelect...
     *     <span style="color: #553000">favoliteCB</span>.query().set...
     *     <span style="color: #553000">favoliteCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">user</span>.<span style="color: #CC4747">getFavoliteList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Favolite> loadFavolite(User user, ReferrerConditionSetupper<FavoliteCB> refCBLambda) {
        xassLRArg(user, refCBLambda);
        return doLoadFavolite(xnewLRLs(user), new LoadReferrerOption<FavoliteCB, Favolite>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<Favolite> doLoadFavolite(List<User> userList, LoadReferrerOption<FavoliteCB, Favolite> option) {
        return helpLoadReferrerInternally(userList, option, "favoliteList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">loadFollowByFolloweeId</span>(<span style="color: #553000">userList</span>, <span style="color: #553000">followCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Follow> loadFollowByFolloweeId(List<User> userList, ReferrerConditionSetupper<FollowCB> refCBLambda) {
        xassLRArg(userList, refCBLambda);
        return doLoadFollowByFolloweeId(userList, new LoadReferrerOption<FollowCB, Follow>().xinit(refCBLambda));
    }
     ...
     * FOLLOW by FOLLOWEE_ID, named 'followByFolloweeIdList'.
     * <pre>
     * <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">loadFollowByFolloweeId</span>(<span style="color: #553000">user</span>, <span style="color: #553000">followCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">followCB</span>.setupSelect...
     *     <span style="color: #553000">followCB</span>.query().set...
     *     <span style="color: #553000">followCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">user</span>.<span style="color: #CC4747">getFollowByFolloweeIdList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Follow> loadFollowByFolloweeId(User user, ReferrerConditionSetupper<FollowCB> refCBLambda) {
        xassLRArg(user, refCBLambda);
        return doLoadFollowByFolloweeId(xnewLRLs(user), new LoadReferrerOption<FollowCB, Follow>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<Follow> doLoadFollowByFolloweeId(List<User> userList, LoadReferrerOption<FollowCB, Follow> option) {
        return helpLoadReferrerInternally(userList, option, "followByFolloweeIdList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">loadFollowByFollowerId</span>(<span style="color: #553000">userList</span>, <span style="color: #553000">followCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">followCB</span>.setupSelect...
     *     <span style="color: #553000">followCB</span>.query().set...
     *     <span style="color: #553000">followCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Follow> loadFollowByFollowerId(List<User> userList, ReferrerConditionSetupper<FollowCB> refCBLambda) {
        xassLRArg(userList, refCBLambda);
        return doLoadFollowByFollowerId(userList, new LoadReferrerOption<FollowCB, Follow>().xinit(refCBLambda));
    }
     ...
     * FOLLOW by FOLLOWER_ID, named 'followByFollowerIdList'.
     * <pre>
     * <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">loadFollowByFollowerId</span>(<span style="color: #553000">user</span>, <span style="color: #553000">followCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">followCB</span>.setupSelect...
     *     <span style="color: #553000">followCB</span>.query().set...
     *     <span style="color: #553000">followCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">user</span>.<span style="color: #CC4747">getFollowByFollowerIdList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Follow> loadFollowByFollowerId(User user, ReferrerConditionSetupper<FollowCB> refCBLambda) {
        xassLRArg(user, refCBLambda);
        return doLoadFollowByFollowerId(xnewLRLs(user), new LoadReferrerOption<FollowCB, Follow>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<Follow> doLoadFollowByFollowerId(List<User> userList, LoadReferrerOption<FollowCB, Follow> option) {
        return helpLoadReferrerInternally(userList, option, "followByFollowerIdList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">loadReplyByReplyeeId</span>(<span style="color: #553000">userList</span>, <span style="color: #553000">replyCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Reply> loadReplyByReplyeeId(List<User> userList, ReferrerConditionSetupper<ReplyCB> refCBLambda) {
        xassLRArg(userList, refCBLambda);
        return doLoadReplyByReplyeeId(userList, new LoadReferrerOption<ReplyCB, Reply>().xinit(refCBLambda));
    }
     ...
     * REPLY by REPLYEE_ID, named 'replyByReplyeeIdList'.
     * <pre>
     * <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">loadReplyByReplyeeId</span>(<span style="color: #553000">user</span>, <span style="color: #553000">replyCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">replyCB</span>.setupSelect...
     *     <span style="color: #553000">replyCB</span>.query().set...
     *     <span style="color: #553000">replyCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">user</span>.<span style="color: #CC4747">getReplyByReplyeeIdList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Reply> loadReplyByReplyeeId(User user, ReferrerConditionSetupper<ReplyCB> refCBLambda) {
        xassLRArg(user, refCBLambda);
        return doLoadReplyByReplyeeId(xnewLRLs(user), new LoadReferrerOption<ReplyCB, Reply>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<Reply> doLoadReplyByReplyeeId(List<User> userList, LoadReferrerOption<ReplyCB, Reply> option) {
        return helpLoadReferrerInternally(userList, option, "replyByReplyeeIdList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">loadReplyByReplyerId</span>(<span style="color: #553000">userList</span>, <span style="color: #553000">replyCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">replyCB</span>.setupSelect...
     *     <span style="color: #553000">replyCB</span>.query().set...
     *     <span style="color: #553000">replyCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Reply> loadReplyByReplyerId(List<User> userList, ReferrerConditionSetupper<ReplyCB> refCBLambda) {
        xassLRArg(userList, refCBLambda);
        return doLoadReplyByReplyerId(userList, new LoadReferrerOption<ReplyCB, Reply>().xinit(refCBLambda));
    }
     ...
     * REPLY by REPLYER_ID, named 'replyByReplyerIdList'.
     * <pre>
     * <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">loadReplyByReplyerId</span>(<span style="color: #553000">user</span>, <span style="color: #553000">replyCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">replyCB</span>.setupSelect...
     *     <span style="color: #553000">replyCB</span>.query().set...
     *     <span style="color: #553000">replyCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">user</span>.<span style="color: #CC4747">getReplyByReplyerIdList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Reply> loadReplyByReplyerId(User user, ReferrerConditionSetupper<ReplyCB> refCBLambda) {
        xassLRArg(user, refCBLambda);
        return doLoadReplyByReplyerId(xnewLRLs(user), new LoadReferrerOption<ReplyCB, Reply>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<Reply> doLoadReplyByReplyerId(List<User> userList, LoadReferrerOption<ReplyCB, Reply> option) {
        return helpLoadReferrerInternally(userList, option, "replyByReplyerIdList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">loadRetweet</span>(<span style="color: #553000">userList</span>, <span style="color: #553000">retweetCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Retweet> loadRetweet(List<User> userList, ReferrerConditionSetupper<RetweetCB> refCBLambda) {
        xassLRArg(userList, refCBLambda);
        return doLoadRetweet(userList, new LoadReferrerOption<RetweetCB, Retweet>().xinit(refCBLambda));
    }
     ...
     * RETWEET by USER_ID, named 'retweetList'.
     * <pre>
     * <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">loadRetweet</span>(<span style="color: #553000">user</span>, <span style="color: #553000">retweetCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">retweetCB</span>.setupSelect...
     *     <span style="color: #553000">retweetCB</span>.query().set...
     *     <span style="color: #553000">retweetCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">user</span>.<span style="color: #CC4747">getRetweetList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Retweet> loadRetweet(User user, ReferrerConditionSetupper<RetweetCB> refCBLambda) {
        xassLRArg(user, refCBLambda);
        return doLoadRetweet(xnewLRLs(user), new LoadReferrerOption<RetweetCB, Retweet>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<Retweet> doLoadRetweet(List<User> userList, LoadReferrerOption<RetweetCB, Retweet> option) {
        return helpLoadReferrerInternally(userList, option, "retweetList");
    }
